# Somatic Variant Discovery Repository

This repository is a cleaned and portable copy of the somatic mutation discovery pipeline extracted from the original workspace.
...
1. `preprocessing/0-find_tcga_sample_id.sh`
2. `preprocessing/1-1-match_true_somatic_mutations.sh`
3. `preprocessing/1-2-match_true_duplicated_samples.sh`
4. `preprocessing/1-3-check_matched_numbers.sh`
5. `preprocessing/2-process_oneKG.sh`
6. `preprocessing/3-process_features.sh`
7. `preprocessing/4-filter_new.sh`
8. `preprocessing/5a-gnomad_download.sh` (optional)
9. `preprocessing/5b-gnomad_match_AF_chr.sh`
10. `preprocessing/5c-gnomad_combine.sh`
11. `preprocessing/6a-annotations_convert.sh`
12. `preprocessing/6b-annotations_extract_exons.sh`
13. `preprocessing/6c-annotations_filter_exons.sh`
14. `preprocessing/7-add_vaf_cn.sh`
15. `preprocessing/8-combine_nodup.py`
